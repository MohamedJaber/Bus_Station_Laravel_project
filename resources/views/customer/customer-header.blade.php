<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav navbar-right">
        	@if ( auth()->check() )
            <li><a href="{{ url('/show-bus-list') }}"><span class="glyphicon glyphicon-calendar"></span> Book now</a></li>
        	<li><a href="#"><span class="glyphicon glyphicon-user"></span> {{ auth()->user()->fname }}</a></li>
